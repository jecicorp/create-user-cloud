<html>
  <p style="margin-top:0pt;margin-bottom:1em;font-family:Arial;font-size:12pt">
    <span>Bonjour M. ${createdUser.properties["cm:firstName"]} ${createdUser.properties["cm:lastName"]},</span>
  </p>

  <p style="margin-top:1em;margin-bottom:1em;font-family:Arial;font-size:12pt">
    <span>${currentUser.properties["cm:firstName"]} ${currentUser.properties["cm:lastName"]} vient de vous créer un compte sur notre plateforme de démo</span>
  ...
  <p style="margin-top:1em;margin-bottom:1em;font-family:Arial;font-size:12pt">
    ...
    <span>Vous pouvez évidemment ajouter les dossiers et documents de votre choix.</span>
  </p>

  <p style="margin-top:1em;margin-bottom:1em;font-family:Arial;font-size:12pt">
    <span>Nous restons à votre disposition si vous avez des questions ou besoins de précisions.</span><br />
    <span>Vous pouvez nous contacter à </span>
